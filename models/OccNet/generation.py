...
class Generator3D(object):
    ...
    Args:
        decoder (nn.Module): trained Occupancy Network decoder model
    ...
    def __init__(self, model, points_batch_size=100000,
                 threshold=0.2, refinement_step=0, device=None,
                 resolution0=32, upsampling_steps=2,
    ...
    def generate_mesh_from_latent(self, c):
        ...
        mesh = self.generate_from_latent(z, input_latentcode, stats_dict=stats_dict, **kwargs)
