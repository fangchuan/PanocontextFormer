...
from train_detection_layoutmesh_0102 import physical_violation_loss
...
if __name__ == '__main__':
    ...
    opt = parse_option()
    opt.checkpoint_path = "log/panocontextformer_0114_F2/igibson_1673696277/ckpt_epoch_last.pth"
    opt.avg_times = 1
