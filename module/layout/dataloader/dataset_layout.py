...
import module.layout.private_loss as private_loss
import cv2
...
class PanoCorBonDataset(data.Dataset):
    ...
    def __init__(self, root_dir,
        ...
        _, self.unit_lonlat, self.unit_xyz = private_loss.create_grid([512, 1024])
...
def rotate_cor(corners,R):
#    uv to xyz; rotated xyz; xyz to uv
    return
