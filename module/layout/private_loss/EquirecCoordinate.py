...
if __name__ == '__main__':
    transformer = EquirecTransformer(mode='numpy')
    XY = np.array([655, 133])

    print("input XY: ", XY)

    lonlat = transformer.XY2lonlat(XY)
    print('lonlat :', lonlat)

    xyz = transformer.lonlat2xyz(lonlat)
    xyz2 = transformer.XY2xyz(XY)

    print("xyz = ", xyz)
    print("xyz2 = ", xyz2)

    lonlat2 = transformer.xyz2lonlat(xyz)
    print('lonlat2 :', lonlat2)

    recovered_XY = transformer.lonlat2XY(lonlat)
    print('recovered XY: ', recovered_XY)

    recovered_XY2 = transformer.xyz2XY(xyz)
    print('recovered XY2: ', recovered_XY2)
