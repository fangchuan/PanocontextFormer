...
from module.deep3dlayout.attention import MHSATransformerPos
...
class gravity_projection(nn.Module):        
    ...
    #     '/Users/yuandong/Documents/Git_project_DAMO/gp3d_private/igibson/example_data/igbison_image/Beechwood_0_int_00000.png'),
    #                np.float32)[..., :3] / 255.
    # img_tensor = torch.FloatTensor(img.transpose([2, 0, 1]).copy())
    # verts, faces, aux = load_obj(
    #     '/Users/yuandong/Documents/Git_project_DAMO/gp3d_private_HorizonNet/Beechwood_0_int_00000_gtmesh.obj')
    # meshes_gt = Meshes(verts=[verts], faces=[faces.verts_idx])
    # points_gt, normals_gt = sample_points_from_meshes(meshes_gt, num_samples=100000, return_normals=True)
    #
    # ###
    # uv_inputs = xy2uv(points_gt)  ####mesh device
    # colors = self.slice_projection(uv_inputs, img_tensor.unsqueeze(0))
    # pcd = o3d.geometry.PointCloud()
    # pcd.points = o3d.utility.Vector3dVector(points_gt.squeeze())
    # pcd.colors = o3d.utility.Vector3dVector(colors.squeeze())
    # o3d.io.write_point_cloud('Beechwood_0_int_00000_gtmesh.ply', pcd)
