...
class gravity_projection(nn.Module):        
    def __init__(self, lfeats = 1024, use_mhsa = False, num_heads = 4, hdim_factor = 2, use_pos_encoding = False, verts_count = 642):
    ...
    def forward(self, img_features, inputs, get_vertices = True, return_packed=False):
        ###
